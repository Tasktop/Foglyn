 ...
 * @author David Green
 */
class FoglynFillWidthLayout extends Layout implements ILayoutExtension {
	 ...
	 */
	public FoglynFillWidthLayout(int marginLeft, int marginRight, int marginTop, int marginBottom) {
	 ...
	 *            the bottom margin in pixels, or 0 if there should be none
	 */
	public FoglynFillWidthLayout(Composite layoutAdvisor, int marginLeft, int marginRight, int marginTop, int marginBottom) {
